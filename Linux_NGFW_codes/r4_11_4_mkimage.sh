...
e2fsck -f /dev/sda3
tune2fs /dev/sda3 -U 437408e9-9c3f-4951-ba61-81de70b19b28


rsync -av ~/rasool_lsf_aarch64_usb_bk20220925/ /media/temp3 --exclude busybox-1.33.2/ --exclude busybox-1.33.2.tar.bz2 --exclude lfs-packages-11.0.tar --exclude lfs-scripts-master/ --exclude sources/ --exclude raspberrypi/ --exclude temp1_rasool_linux_image/ --exclude master.zip --exclude rootfs/ --exclude u-boot/ --exclude usr/share/doc/
rm /media/temp3/boot/*
